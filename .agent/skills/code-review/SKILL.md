---
name: Code Review
description: Pre-commit code quality review for Unity C# code. Checks against RULES.md, CODING_STANDARDS.md, NAMING_CONVENTIONS.md, and GDD Gherkin test coverage. Use when code has been written and tests are passing but before committing. Runs automatically at Step 8.5 of /implement-feature. Triggers on "review this code", "check my implementation", "pre-commit review", "code review", or "check before commit".
---
...
### 6. Game Feel
- [ ] If "later" was chosen in `/implement-feature` Step 3: `// TODO(gamefeel): [feature] — pending` comment exists in the main script
