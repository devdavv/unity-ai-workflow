...
## Responsibilities
- Guide the user through the **Pre-Production Questionnaire** to fill out `ProjectConfig.yaml`.
...
- **GitHub MCP**: Creates the repository, `.gitignore`, initial branch structure.
